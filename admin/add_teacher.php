    ...
    */
    ...
    if ($middle_name !== '') {
        ...
        if (strlen($middle_name) > 150) {
            ...
            $errors[] =
                'Middle name cannot exceed 150 characters.';
    ...
    // Phone (optional, must contain only digits, spaces, + - ( ) )
    if ($phone !== '') {
        ...
        if (preg_match("/[a-zA-Z]/", $phone)) {
            ...
            $errors[] =
                'Phone number may only contain digits, spaces, and + - ( ) characters.';
    ...
    if ($employee_no === '') {
        ...
        $errors[] =
            'Employee number cannot exceed 20 characters.';

    } elseif (!preg_match("/^[a-zA-Z0-9\-]+$/", $employee_no)) {

        $errors[] =
            'Employee number may only contain letters, digits and hyphens.';
    }
        ...
        */
        ...
        try {
            ...
            */
            ...
            header(
                'Location: teachers.php?success=teacher_created'
            );
...
<main class="main-content">
    ...
    >
        ...
        <div class="section-header">
            ...
            <p>
                Enter the teacher's personal, employment and login information.
            </p>
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            <option
                                value="inactive"
                                <?php
                                echo $employment_status === 'inactive'
                                    ? 'selected'
                                    : '';
                                ?>
                            >
...
function blockLetters(input) {
    ...
    // Remove any alphabetic character

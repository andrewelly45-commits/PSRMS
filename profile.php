...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['ajax_action'])) {
    ...
    if ($ajax_action === 'update_profile') {
        ...
        try {
            ...
            if ($role === 'parent' && tableExists($conn, 'parents')) {
                $stmt = mysqli_prepare(
                    $conn,
            ...
            if ($role === 'teacher' && tableExists($conn, 'teachers')
                && columnExists($conn, 'teachers', 'qualification')) {
                $stmt = mysqli_prepare(
                    $conn,
                    "UPDATE teachers SET qualification = ? WHERE user_id = ?"
                );
                if ($stmt) {
                    mysqli_stmt_bind_param($stmt, 'si', $qualification, $user_id);
                    mysqli_stmt_execute($stmt);
                    mysqli_stmt_close($stmt);
                }
            }
...
$stmt = mysqli_prepare(
    ...
    "SELECT
        ...
        email, phone, gender, profile_pic, role, status, created_at
     FROM users
     WHERE user_id = ?
     LIMIT 1"
);
...
$initial = strtoupper(mb_substr($user['first_name'] ?: $full_name, 0, 1));
...
if ($role === 'parent' && tableExists($conn, 'parents')) {
    $stmt = mysqli_prepare(
        $conn,
        "SELECT parent_id, occupation, address FROM parents WHERE user_id = ? LIMIT 1"
    );
    $parent_id = 0;
    if ($stmt) {
        mysqli_stmt_bind_param($stmt, 'i', $user_id);
    ...
    if ($parent_id && tableExists($conn, 'parent_children')) {
...
if ($role === 'teacher' && tableExists($conn, 'teachers')
    && columnExists($conn, 'teachers', 'qualification')) {
    $stmt = mysqli_prepare($conn, "SELECT qualification FROM teachers WHERE user_id = ? LIMIT 1");
    if ($stmt) {
        mysqli_stmt_bind_param($stmt, 'i', $user_id);
        mysqli_stmt_execute($stmt);
        $r = mysqli_stmt_get_result($stmt);
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 800px) {
            ...
            .profile-info-rows { padding-top: 12px; margin-top: 0; }
        ...
        @media (max-width: 550px) {
            ...
            .info-row .ico { width: 28px; height: 28px; font-size: 11px; }
            ...
            .info-note { font-size: 11.5px; padding: 11px 12px; }
        ...
        @media (max-width: 380px) {
            ...
            .info-row .lbl { font-size: 9px; }
            .info-row .val { font-size: 11.5px; }
...
<?php
$sidebar_file = $sidebar_map[$role] ?? $sidebar_map['parent'];
if (is_file(__DIR__ . '/' . $sidebar_file)) {
        ...
        <aside class="profile-card">
            ...
            <div class="profile-avatar-wrap">
                <div class="profile-avatar" id="avatarPreview">
                    <?php if (!empty($user['profile_pic']) && is_file(__DIR__ . '/uploads/users/' . $user['profile_pic'])): ?>
                        <img id="avatarImg"
                             src="uploads/users/<?php echo e($user['profile_pic']); ?>?v=<?php echo time(); ?>"
            ...
            <div class="profile-info">
                ...
                <div class="profile-email" id="profileEmail"><?php echo e($user['email']); ?></div>
                ...
                <div class="profile-info-rows">
                    ...
                    <div class="info-row">
                        <div class="ico gold"><i class="fa-solid fa-hashtag"></i></div>
                        <div>
                            <div class="lbl">User ID</div>
                            <div class="val">#<?php echo (int)$user['user_id']; ?></div>
                        </div>
                    </div>
        ...
        <div class="tabs-card">
            ...
            <div class="tab-pane active" id="tab-personal">
                ...
                <form id="profileForm" autocomplete="off">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="first_name" name="first_name" class="form-control"
                                   value="<?php echo e($user['first_name']); ?>" maxlength="100" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="middle_name" name="middle_name" class="form-control"
                                   value="<?php echo e($user['middle_name']); ?>" maxlength="100">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="last_name" name="last_name" class="form-control"
                                   value="<?php echo e($user['last_name']); ?>" maxlength="100" required>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control"
                                   value="<?php echo e($user['email']); ?>" maxlength="150" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone" class="form-control"
                                   value="<?php echo e($user['phone']); ?>" maxlength="30" required>
                        ...
                        <div class="form-grid">
                            <div class="form-group full">
                                ...
                                <input type="text" id="occupation" name="occupation" class="form-control"
                                       value="<?php echo e($occupation); ?>" maxlength="150">
                    ...
                    <?php if ($role === 'teacher'): ?>
                        <div class="form-section-title">Teacher Details</div>
                        <div class="form-grid">
                            <div class="form-group full">
                                <label for="qualification">Qualification</label>
                                <input type="text" id="qualification" name="qualification" class="form-control"
                                       value="<?php echo e($qualification); ?>" maxlength="150">
            ...
            <div class="tab-pane" id="tab-photo">
                ...
                <div class="photo-upload-area">
                    ...
                    <div class="photo-preview-big">
                        <div id="photoPreviewBig" class="photo-preview-inner">
                            <?php if (!empty($user['profile_pic']) && is_file(__DIR__ . '/uploads/users/' . $user['profile_pic'])): ?>
                                <img src="uploads/users/<?php echo e($user['profile_pic']); ?>?v=<?php echo time(); ?>"
                                     alt="<?php echo e($full_name); ?>">
                            <?php else: ?>
                                <?php echo e($initial); ?>
                            <?php endif; ?>
...
profileForm.addEventListener('submit', async e => {
    ...
    try {
        ...
        if (initial) initial.textContent = json.initial;
...
newPwdInput.addEventListener('input', () => {
    ...
    pwdBar.style.width = ((s / 5) * 100) + '%';
    const colors = ['#9b4747', '#9b4747', '#c9a227', '#9a7422', '#3e7655', '#3e7655'];
    pwdBar.style.background = colors[s] || '#9b4747';
    const labels = ['Enter a new password','Very weak','Weak','Fair','Strong','Very strong'];
